...
import { ActivityIcon, ListOrderedIcon } from 'lucide-react';
        ...
        >
          ...
          >
            ...
            <DashboardSidebarPageItem
              ...
              href="/management"
              selected={!!matchPath('/management', pathname)}
              defaultExpanded={!!matchPath('/management', pathname)}
              expanded={expandedItemIds.includes('management')}
              nestedNavigation={
                <List
                  dense
                  sx={{
                ...
                >
                  <DashboardSidebarPageItem
                    ...
                    selected={!!matchPath('/management/employees', pathname)}
                  />
                  <DashboardSidebarPageItem
                    id="accounts"
                    title="Tài khoản"
                  ...
                  <DashboardSidebarPageItem
                    ...
                    selected={!!matchPath('/management/products', pathname)}
                  />
                  <DashboardSidebarPageItem
                    id="categories"
                    title="Loại sản phẩm"
            ...
            <DashboardSidebarPageItem
              ...
              selected={!!matchPath('/management/activities', pathname)}
              defaultExpanded={!!matchPath('/management/activities', pathname)}
              expanded={expandedItemIds.includes('activities')}
              nestedNavigation={
                <List
                  dense
                  sx={{
                ...
                >
                  ...
                  <DashboardSidebarPageItem
                    ...
                    title="Sự kiện"
                    icon={<EventIcon />}
                    href="/management/activities/events"
                    selected={!!matchPath('/management/activities/events', pathname)}
                  />
                </List>
              }
            />
